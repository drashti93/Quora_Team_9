...
import { getQuestionsAnswersForFeedtopic } from "../../actions/alltopicActions";
...
export class TopicFeed extends Component {

	componentDidMount() {
		this.props.getQuestionsAnswersForFeedtopic();
	}
...
const mapActionToProps = (dispatch, props) => {
	return bindActionCreators(
		{
			getQuestionsAnswersForFeedtopic
